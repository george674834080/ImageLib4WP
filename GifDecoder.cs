...
namespace NGif.WindowsPhone
{
    public class GifDecoder
    {
        ...
        public static List<GifFrame> Decode(Stream stream)
        {
 ...
 */
         ...
         */
        private WriteableBitmap GetFrame(int n)
        {
         ...
         */
        private int[] GetPixels(WriteableBitmap bitmap)
        {
